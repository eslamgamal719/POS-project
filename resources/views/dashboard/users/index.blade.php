                            ...
                            <tbody>
                                @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->email }}</td>
                                            <td><img src="{{$user->image_path}}" alt="" style="width: 65px; height: 65px;" class="img-thumbnail"></td>
                                            <td>
                                          ...
                                          @if(auth()->user()->hasPermission('update_users'))
                                              ...
                                              @if(auth()->user()->hasPermission('delete_users'))
                                                  {{--   <a href="{{route('dashboard.users.destroy', $user->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>@lang('site.delete')</a> --}}
