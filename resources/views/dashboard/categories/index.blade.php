                            ...
                            <tbody>
                                @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td><a href="{{route('dashboard.products.index', ['category_id' => $category->id])}}" class="btn btn-info btn-sm" >@lang('site.related_products')</td>
                                            <td>
                                          ...
                                          @if(auth()->user()->hasPermission('update_categories'))
                                              ...
                                              @if(auth()->user()->hasPermission('delete_categories'))
                                                  {{--   <a href="{{route('dashboard.categories.destroy', $category->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>@lang('site.delete')</a> --}}
